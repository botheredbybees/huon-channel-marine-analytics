...
CREATE TABLE IF NOT EXISTS taxonomy_cache (
    ...
    -- Metadata
    data_source TEXT DEFAULT 'inaturalist',
...
-- Total measurements capacity: 12M+
-- Unique parameters: 125+
-- Datasets: 38+
-- Compatible with: timescale/timescaledb:latest-pg18
-- =============================================================================
